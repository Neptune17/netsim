...
def wan_top_test(log_root_dir):
    ...
    config_dict = {
        "nodes": [
            ...
            (objectType.ROUTER, "router1", ["192.168.0.2", "10.0.1.1", "10.0.2.1"], [50, 50], {"192.168.0.0/24" : "192.168.0.2", "192.168.1.0/24" : "10.0.2.1", "192.168.2.0/24" : "10.0.1.1"}, SP(), float('inf')),
            (objectType.ROUTER, "router2", ["192.168.1.2", "10.0.2.2", "10.0.3.1"], [50, 50], {"192.168.1.0/24" : "192.168.1.2", "192.168.0.0/24" : "10.0.2.2", "192.168.2.0/24" : "10.0.3.1"}, SP(), float('inf')),
            (objectType.ROUTER, "router3", ["192.168.2.2", "10.0.3.2", "10.0.1.2"], [50, 50], {"192.168.2.0/24" : "192.168.2.2", "192.168.0.0/24" : "10.0.1.2", "192.168.1.0/24" : "10.0.3.2"}, SP(), float('inf'))
        ],
        "edges": [
            ("192.168.0.1", "192.168.0.2", net_trace),
            ("192.168.0.2", "192.168.0.1", net_trace),
...
def dc_top_test(log_root_dir):
    ...
    config_dict = {
        "nodes": [
            ...
            (objectType.ROUTER, "switch1", ["10.0.0.2", "10.0.1.2", "10.0.2.2"], [50, 50], {"10.0.0.0/24" : "10.0.0.2", "10.0.1.0/24" : "10.0.1.2", "10.0.2.0/24" : "10.0.2.2", "10.1.0.0/16" : "10.0.2.2"}, SP(), float('inf')),
            (objectType.ROUTER, "switch2", ["10.1.0.2", "10.1.1.2", "10.1.2.2"], [50, 50], {"10.1.0.0/24" : "10.1.0.2", "10.1.1.0/24" : "10.1.1.2", "10.1.2.0/24" : "10.1.2.2", "10.0.0.0/16" : "10.1.2.2"}, SP(), float('inf')),
            (objectType.ROUTER, "router1", ["10.1.2.1", "10.0.2.1"], [50, 50], {"10.0.0.0/16" : "10.0.2.1", "10.1.0.0/16" : "10.1.2.1"}, SP(), float('inf'))
        ],
        "edges": [
